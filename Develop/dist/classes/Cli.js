...
class Cli {
    ...
    createVehicle() {
        inquirer
            ...
            if (answers.vehicleType === 'Car') {
                // create a car
                this.createCar(); // TODO: add statements to create a truck or motorbike if the user selects the respective vehicle type
            }
    ...
    createTruck() {
        inquirer
            ...
            // can pass the properties with their types here
            .then((answers) => {
        ...
        inquirer
            .prompt([
            {
                ...
                choices: [
                    ...
                    'Turn left',
                    'Reverse',
                    'Tow a vehicle', //Added for Trucks
                    'Do a wheelie', //Added for wheelie
            ...
            // After calling the findVehicleToTow method, you will need to return to avoid instantly calling the performActions method again since findVehicleToTow is asynchronous.
                ...
                // find the selected vehicle and if the selected vehicle is a truck, towd it
                for (let i = 0; i < this.vehicles.length; i++) {
                    if (this.vehicles[i].vin === this.selectedVehicleVin) {
                        // Check if the selected vehicle has a `towingCapacity` since Only trucks have  this property 
                        if ("towingCapacity" in this.vehicles[i]) {
                            // then call the tow function
                            this.findVehicleToTow(this.vehicles[i]);
                            // Stop further execution, wait for `findVehicleToTow()`
                            return;
                        }
                        else {
            ...
            // TODO: add statements to perform the wheelie action only if the selected vehicle is a motorbike
                ...
                for (let i = 0; i < this.vehicles.length; i++) {
                    if (this.vehicles[i].vin === this.selectedVehicleVin) {
                        // Check if the selected vehicle has a wheelie method 
                        if ("wheelie" in this.vehicles[i]) {
                            // TypeScript now allows calling wheelie() since is Motorbike
